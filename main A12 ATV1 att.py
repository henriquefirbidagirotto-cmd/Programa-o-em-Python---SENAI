...
def restaurante():
    ...
    if p == 'Salada':
        print('sua salada está sendo preparado')
    elif p == 'Salada e macarronada':
        print('sua salada e sua macarronada está sendo preparado')
    elif p == 'Salada, macarronada e sanduiche':
        print('sua salada, macarronada e sanduiche está sendo preparado')
    ...
    if p2 == 's':
        ...
        if p3 == 'sorvete':
            print('seu sorvete está sendo preparado, obrigado volte sempre')
        elif p3 == 'sorvete e pudin':
            print('seu sorvete e seu pudin está sendo preparado, obrigado volte sempre')
        elif p3 == 'petit gateau e pudin':
            print('seu pudin e seu petit gateau está sendo preparado, obrigado volte sempre')
        elif p3 == 'sorvete, pudin e petit gateau':
            print('seu sorvete, pudin e petit gateau está sendo preparado, obrigado volte sempre')
        elif p3 == 'sorvete e petit gateau':
            print('seu  petit gateau e sua sorvete está sendo preparadp, obrigado volte sempre')
